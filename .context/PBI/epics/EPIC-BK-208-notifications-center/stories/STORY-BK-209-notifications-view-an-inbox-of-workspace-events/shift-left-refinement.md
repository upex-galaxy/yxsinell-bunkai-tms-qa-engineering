...
- Light code evidence: `../upex-bunkai-tms/supabase/migrations/0009_cross_cutting.sql`, `0036_run_abort.sql`, `0037_run_finish.sql`, `app/(app)/layout.tsx`, `components/layout/AppSidebar.tsx`.
